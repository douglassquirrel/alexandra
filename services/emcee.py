...
def install_game(game_dir, install_dir, libraries_dir):
    ...
    copy('run_components.py', install_dir)
...
def start_game(message, games_dir, libraries_dir, docstore_url):
    ...
    install_game(game_dir, install_dir, libraries_dir)
...
pubsub.consume_topic('game.wanted', lambda m: start_game(m, games_dir, libraries_dir, docstore_url))
